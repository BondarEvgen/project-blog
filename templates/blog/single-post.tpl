<main class="page-post">
		<section class="page-post__post">
			<div class="section-posts">
				...
				<div class="section-posts__info"><?php echo date('j F Y', $post[ 'timestamp' ]);?></div>
        ...
        <?php endif;?>
			...
			<div class="page-post__post-pagination">
				<div class="post-pagination"> <a class="post-pagination__button" href="#">Back </a><a class="post-pagination__button post-pagination__button--forward" href="#">Next</a></div>
			</div>
		</section>
